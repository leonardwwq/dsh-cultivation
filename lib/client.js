...
`;
    ...
    function exportRole(id) {
      ...
      const payload = { app: "dsh-cultivation", version: 3, name: tpl.name, fields: tpl.fields, memory: tpl.memory && typeof tpl.memory === "object" ? tpl.memory : (typeof tpl.memory === "string" ? tpl.memory : ""), memoryLog: Array.isArray(tpl.memoryLog) ? tpl.memoryLog : [], growth: Array.isArray(tpl.growth) ? tpl.growth : [] };
      try {
