...
`;
    ...
    function openNewRole() {
      setStore({ open: true, isNew: true, editingTemplateId: null, draft: { id: "draft", name: "新角色", intimacy: 0, fields: emptyFields() }, saveState: "idle" });
    }
    function saveNow() {
      const s = getStore();
      if (s.isNew && s.draft) {
    ...
    function exportRole(id) {
      ...
      const payload = { app: "dsh-cultivation", version: 4, name: tpl.name, fields: tpl.fields, memory: tpl.memory && typeof tpl.memory === "object" ? tpl.memory : (typeof tpl.memory === "string" ? tpl.memory : ""), memoryLog: Array.isArray(tpl.memoryLog) ? tpl.memoryLog : [], growth: Array.isArray(tpl.growth) ? tpl.growth : [], mood: tpl.mood && typeof tpl.mood === "object" ? tpl.mood : null };
      try {
